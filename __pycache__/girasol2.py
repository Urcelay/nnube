from turtle import *#dibuja graficos
from math import *
import turtle
import pygame
...
for i in range(16):#veces que se mueve en la circunferencia
    for j in range(18):#veces que se mueve adentro del ovalo
        color("#FFA216"), rt(90) #la tortuga gira a 90grados
...
def dibujar_A(x,y):
    pos_a=[(x,y), (x+2, y+4),(x+4,y+8),(x+6,y+12),(x+8,y+16),
           (x+10,y+20),(x+12,y+24),(x+14,y+20),(x+16,y+16),
           (x+18,y+12),(x+20,y+8),(x+22,y+4),(x+24,y),
           (x+8,y+8),(x+12,y+8),(x+16,y+8)]
